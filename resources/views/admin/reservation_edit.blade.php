                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr><th><b>Price</b></th><td>{{$data->service->price}}₺</td></tr>
                                        <tr><th><b>Reservation Detail</b></th><td>{{$data->day}}/{{$data->month}}/{{$data->year}} - {{$data->hour}}:{{$data->minute}}0</td></tr>
