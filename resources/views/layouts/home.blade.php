...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/{{ asset('assets/css?family=Roboto:300,300i,400,400i,500,500i,700,700i%7cMontserrat:300,300i,400,400i,500,500i,600,600i,700,700i') }}" rel="stylesheet">
    <!-- Font Awesome -->
    ...
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/.footer-->
